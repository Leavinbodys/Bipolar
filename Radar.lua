...
do
    ...
    local retardedGames = {
        123;   -- Phantom forces - support might be added
        123;  -- Bad business
        123;  -- Trident survival (server browser?) - support might be added
        123;  -- Trident survival (server) - support might be added
    }
    local gameNotes = {
        [123] = 'This game is known to fuck up the radar - waiting a round should fix'; -- Assassins
        [123] = 'Players that are lassoed don\'t appear on the radar properly'; -- Westbound 
    }
